...
function getFormInput() {
  ...
  if (item == "Archetype Gojira") {
    ...
    OUTPUT.innerHTML += "<div class='positionText9'><p>You have just added Archetype Gojira to your cart</p><br><br></div>";
  }
  else if (item == "Archetype Petrucci") {    
    OUTPUT.innerHTML += "<div class='positionText9'><p>You have just added Archetype Petrucci to your cart</p><br><br></div>";
    
  }
  else if (item == "Archetype Abasi") {
    
    OUTPUT.innerHTML += "<div class='positionText9'><p>You have just added Archetype Abasi to your cart</p><br><br></div>";
